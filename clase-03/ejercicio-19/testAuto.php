...
$auto6 = new Auto("Citroen", "Negro", 13200, date("d-m-Y"));

$listaAutos = array($auto1, $auto2, $auto3, $auto4, $auto5, $auto6);

// Muestra de vehiculos creados
foreach ($listaAutos as $key => $value) {
  echo Auto::GuardarAuto($value) . "<br/>";
}
echo "<br/>";
echo "<br/>";
...
echo "<h1>Lista de autos guardados en archivo 'autos.csv': </h1>";
foreach ($autosGuardados as $key => $value) {
  echo "<h2>Auto[" . $key . "] " . Auto::MostrarAuto($value) . "</h2>";
}
echo "<br/>";
echo "<br/>";
