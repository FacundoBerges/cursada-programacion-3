...
class Producto
{
  ...
  public static function Guardar($producto)
  {
    ...
    $index = Producto::productoExistente($listaProductos, $producto);
  ...
  public static function productoExistente($listaProductos, $producto)
  {
    $valores = array_values($listaProductos);

    foreach ($valores as $key => $value) {

      if ($value["codigoBarras"] == $producto->codigoBarras) {
        return $key;
      }
    }
